package nl.han.toetsplatform.module.nakijken.data.data.sql;//package nl.han.toetsplatform.module.nakijken.data.sql;
//
...
//
//    @Override
//    public void saveNakijkmodel(NakijkModel nakijkModel) {
//        Connection conn = _storageDao.getConnection();
//        if(!isDatabaseConnected(conn))  return;
//
//        try {
//            PreparedStatement psResultaat = conn.prepareStatement(_sqlLoader.load("insert_NAKIJKMODEL"));
//            psResultaat.setString(1, nakijkModel.getNakijkModelVersie());
//            psResultaat.setString(2, nakijkModel.getVraagId());
//            psResultaat.setString(3, nakijkModel.getVraagVersie());
//            psResultaat.setString(4, nakijkModel.getCorrecteAntwoorden());
//            psResultaat.setString(5, nakijkModel.getNakijkInstrucites());
//
//            psResultaat.execute();
